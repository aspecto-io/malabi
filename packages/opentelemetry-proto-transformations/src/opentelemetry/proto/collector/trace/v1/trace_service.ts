...
export const ExportTraceServiceRequest = {
    ...
    fromPartial(object: DeepPartial<ExportTraceServiceRequest>): ExportTraceServiceRequest {
        const message = {
            ...baseExportTraceServiceRequest,
        } as ExportTraceServiceRequest;
        message.resourceSpans = [];
...
export const ExportTraceServiceResponse = {
    encode(_: ExportTraceServiceResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        return writer;
    },
    ...
    fromPartial(_: DeepPartial<ExportTraceServiceResponse>): ExportTraceServiceResponse {
        const message = {
            ...baseExportTraceServiceResponse,
        } as ExportTraceServiceResponse;
        return message;
...
export class TraceServiceClientImpl implements TraceService {
    ...
    Export(request: ExportTraceServiceRequest): Promise<ExportTraceServiceResponse> {
        ...
        const promise = this.rpc.request('opentelemetry.proto.collector.trace.v1.TraceService', 'Export', data);
        return promise.then((data) => ExportTraceServiceResponse.decode(new _m0.Reader(data)));
    }
}
