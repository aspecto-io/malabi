...
export function status_DeprecatedStatusCodeFromJSON(
  object: any
...
export function status_DeprecatedStatusCodeToJSON(
  object: Status_DeprecatedStatusCode
): string {
  switch (object) {
...
export const ResourceSpans = {
  ...
  fromJSON(object: any): ResourceSpans {
    ...
    if (
      object.instrumentationLibrarySpans !== undefined &&
      object.instrumentationLibrarySpans !== null
    ) {
      for (const e of object.instrumentationLibrarySpans) {
        message.instrumentationLibrarySpans.push(
          InstrumentationLibrarySpans.fromJSON(e)
        );
      }
    }
    return message;
  ...
  toJSON(message: ResourceSpans): unknown {
    ...
    if (message.instrumentationLibrarySpans) {
      obj.instrumentationLibrarySpans = message.instrumentationLibrarySpans.map(
        (e) => (e ? InstrumentationLibrarySpans.toJSON(e) : undefined)
      );
    } else {
  ...
  fromPartial(object: DeepPartial<ResourceSpans>): ResourceSpans {
    ...
    if (
      ...
      for (const e of object.instrumentationLibrarySpans) {
        message.instrumentationLibrarySpans.push(
          InstrumentationLibrarySpans.fromPartial(e)
        );
      }
    }
    return message;
...
export const InstrumentationLibrarySpans = {
  ...
  fromJSON(object: any): InstrumentationLibrarySpans {
    ...
    if (
      ...
      message.instrumentationLibrary = InstrumentationLibrary.fromJSON(
  ...
  fromPartial(
    object: DeepPartial<InstrumentationLibrarySpans>
  ): InstrumentationLibrarySpans {
    const message = {
      ...baseInstrumentationLibrarySpans,
    } as InstrumentationLibrarySpans;
    ...
    if (
      ...
      message.instrumentationLibrary = InstrumentationLibrary.fromPartial(
        object.instrumentationLibrary
      );
    } else {
      message.instrumentationLibrary = undefined;
...
export const Span = {
  ...
  fromJSON(object: any): Span {
    ...
    if (
      object.startTimeUnixNano !== undefined &&
    ...
    if (
      object.endTimeUnixNano !== undefined &&
      object.endTimeUnixNano !== null
    ) {
    ...
    if (
      object.droppedEventsCount !== undefined &&
      object.droppedEventsCount !== null
    ) {
    ...
    if (
      object.droppedLinksCount !== undefined &&
      object.droppedLinksCount !== null
    ) {
  ...
  toJSON(message: Span): unknown {
    ...
    message.droppedEventsCount !== undefined &&
      (obj.droppedEventsCount = message.droppedEventsCount);
    if (message.links) {
    ...
    message.droppedLinksCount !== undefined &&
      (obj.droppedLinksCount = message.droppedLinksCount);
    message.status !== undefined &&
...
export const Status = {
  ...
  fromJSON(object: any): Status {
    ...
    if (object.deprecatedCode !== undefined && object.deprecatedCode !== null) {
      message.deprecatedCode = status_DeprecatedStatusCodeFromJSON(
        object.deprecatedCode
      );
    } else {
  ...
  toJSON(message: Status): unknown {
    ...
    message.deprecatedCode !== undefined &&
      (obj.deprecatedCode = status_DeprecatedStatusCodeToJSON(
        message.deprecatedCode
      ));
